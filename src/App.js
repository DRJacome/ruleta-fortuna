...
function App() {
  ...
  const posicionTirada = () => {
    ...
    switch (true) {
      case (gradosRotacion >= 0 && gradosRotacion <= 44) || (gradosRotacion >= 180 && gradosRotacion <= 224):
        ...
        <section>
          ...
          <div className='tablero'>
            ...
            <div className='lanzador'>
              {situacion === 0 &&
                <div className='indicador'>
                  <div className='indicadorPotencia' ref={barraRef}></div>
                </div>
              }
            </div>
            ...
            <div className='marcador'>
              <img src='./assets/central.png' alt='Logo central' />
            </div>
          </div>
        </section>
        <footer>
